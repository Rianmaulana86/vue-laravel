                    ...
                    <div class="card-body">
                        <form  method="post" @submit.prevent="update">
                                ...
                                <div class="form-group">
                                    ...
                                    <select @change="selectedSubject"  class="form-select" id="subject">
    ...
    export default {
        ...
        methods: {
            ...
            async getNotes() {
                ...
                let response = await axios.get('/api/detail-note/' + this.$route.params.noteSlug)
            ...
            async update() {
                ...
                let response = await axios.patch(`/api/edit-note/${this.$route.params.noteSlug}`, this.form)
                if (response.status == 200)
                {
